    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="p-6 pb-4 border-b border-slate-100 dark:border-slate-800 flex items-start justify-between">
          <div>
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#0a192f]/10 text-[#0a192f] text-xs font-semibold mb-2">
        ...
        <div className="p-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#0a192f]/20 focus:border-[#0a192f] text-slate-900 dark:text-white"
              autoFocus
            />
          </div>
        </div>
                ...
                >
                  <div
                    className={`flex items-center justify-between p-3.5 rounded-2xl transition-all ${
                      isSelected
                        ? 'bg-[#0a192f]/5 dark:bg-[#0a192f]/20 border border-[#0a192f]/30 shadow-sm'
                    ...
                    <div className="flex items-center gap-3.5">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <h4 className="font-semibold text-slate-900 dark:text-white text-sm group-hover:text-[#0a192f] transition-colors">
                            {college.name}
                          </h4>
                          {isSelected && (
                            <span className="flex items-center gap-1 text-[11px] font-semibold text-[#0a192f] bg-[#0a192f]/10 px-2 py-0.5 rounded-full">
